def send_email(message, recipient, *, sender='university.help@gmail.com'):
    if len(recipient) <= 4 or len(sender) <= 4:  # защита от ввода коротких строк и последующей ошибки в индексах
        print('Невозможно отправить письмо с такими адресами')
        return
    ...
    s3 = sender[-3:]
    s4 = sender[-4:]
    recipient_is_good = ('@' in recipient and (r4 == '.com' or r3 == '.ru' or r4 == '.net'))
    sender_is_good = ('@' in sender and (s4 == '.com' or s3 == '.ru' or s4 == '.net'))
    if not recipient_is_good or not sender_is_good:
